package br.com.newsapp.presentation.home
...
import br.com.newsapp.presentation.common.ArticlesList
import br.com.newsapp.presentation.common.SearchBar
...
fun HomeScreen(
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(top = MediumPadding1, start = ExtraSmallPadding2, end = ExtraSmallPadding2)
            .statusBarsPadding()
    ) {
        Image(
